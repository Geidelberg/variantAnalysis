...
# metadata 
civetfn =  list.files(  '/cephfs/covid/bham/results/phylogenetics/20210604/beta/civet' , patt = 'cog_global_[0-9\\-]+_public.csv', full.names=TRUE) #'../phylolatest/civet/cog_global_2020-12-01_metadata.csv'
